...
func bubbleColors(typ int) (border, bg, text color.Color) {
	...
	case kBubbleWhisper:
		border = color.NRGBA{0xa0, 0x80, 0xff, 0xff}
		bg = color.NRGBA{0x33, 0x00, 0x66, alpha}
		text = color.White
	case kBubbleYell:
		border = color.NRGBA{0xff, 0x66, 0x00, 0xff}
		bg = color.NRGBA{0xff, 0xff, 0x99, alpha}
		text = color.Black
	case kBubbleThought, kBubblePonder:
		border = color.NRGBA{0x00, 0x99, 0xcc, 0xff}
		bg = color.NRGBA{0xcc, 0xee, 0xff, alpha}
		text = color.NRGBA{0x00, 0x33, 0x66, 0xff}
	case kBubbleRealAction:
		border = color.NRGBA{0x00, 0x66, 0x99, 0xff}
		bg = color.NRGBA{0xe0, 0xf7, 0xff, alpha}
		text = color.Black
	case kBubblePlayerAction:
		border = color.NRGBA{0x99, 0x33, 0x00, 0xff}
		bg = color.NRGBA{0xff, 0xe0, 0xcc, alpha}
		text = color.Black
	case kBubbleNarrate:
		border = color.NRGBA{0x33, 0x99, 0x33, 0xff}
		bg = color.NRGBA{0xe0, 0xf7, 0xe0, alpha}
		text = color.Black
	case kBubbleMonster:
		border = color.NRGBA{0x66, 0x00, 0x66, 0xff}
		bg = color.NRGBA{0x33, 0x00, 0x33, alpha}
		text = color.White
	default:
